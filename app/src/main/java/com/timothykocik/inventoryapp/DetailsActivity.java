...
/**
 * Created by jenniferkocik on 2/9/17.
 */
...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        priceEdit = (EditText) findViewById(R.id.product_price);
        quantityEdit = (EditText) findViewById(R.id.quantity_edit);
        supplierNameEdit = (EditText) findViewById(R.id.supplier_name_edit);
        supplierPhoneEdit = (EditText) findViewById(R.id.supplier_phone);
        supplierEmailEdit = (EditText) findViewById(R.id.supplier_email);
        decreaseQuantity = (Button) findViewById(R.id.subtract);
        increaseQuantity = (Button) findViewById(R.id.add_product);
